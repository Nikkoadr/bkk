...
<body>
    ...
    <h3 class="text-center">
        <img src="{{ asset('assets/dist/img/BKK_kecil.png') }}" alt="Left Logo" style="height: 50px; float: left; margin-right: 10px;">
        <b>Bukti Pendaftaran</b>
        <img src="{{ asset('assets/dist/img/logoKotak_kecil.png') }}" alt="Right Logo" style="height: 50px; float: right; margin-left: 10px;">
    </h3>
